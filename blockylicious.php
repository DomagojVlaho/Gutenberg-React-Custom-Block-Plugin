...
final class Blockylicious {
	static function init() {
		...
		add_action( 'init', function() {
			...
			register_block_type( __DIR__ . '/build/blocks/picGallery' );
			register_block_type( __DIR__ . '/build/blocks/picImage' );
			...
			register_block_pattern('blockylicious/call-to-action', array(
				...
				'content' => '<!-- wp:heading {"textAlign":"center"} -->
						...
						<p class="has-text-align-center">Some paragraph text as a sub heading</p>
						<!-- /wp:paragraph -->

						<!-- wp:blockylicious/clicky-group {"justifyContent":"center"} -->
						<!-- wp:blockylicious/clicky-button {"style":{"color":{"background":"#000000","text":"#ffffff"},"spacing":{"padding":{"top":"10px","right":"20px","bottom":"10px","left":"20px"}}},"labelText":"Call to action"} /-->
